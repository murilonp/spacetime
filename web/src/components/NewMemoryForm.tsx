...
export default function NewMemoryForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="inline-block self-end rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-gray-950 transition-colors hover:bg-green-700"
      >
        SALVAR
      </button>
    </form>
